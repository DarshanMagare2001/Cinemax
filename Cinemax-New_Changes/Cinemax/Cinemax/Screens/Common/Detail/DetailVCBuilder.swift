...
public final class DetailVCBuilder {
    ...
    static func build(movieData: MasterMovieModelResult?) -> UIViewController {
        ...
        let presenter = DetailVCPresenter(view: detailVC, interactor: interactor, router: router, movieData: movieData, realmDataRepositoryManager: RealmDataRepositoryManager.shared)
